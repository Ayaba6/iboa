...
class StoreQuoteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // [Ventes §UI] Ces trois champs portent l'astérisque rouge à l'écran mais
            // étaient `nullable` : ni le navigateur ni le serveur ne les exigeaient.
            // Un astérisque décoratif est pire qu'aucun — il fait croire à un contrôle
            // qui n'existe pas. La date de validité commande la péremption du devis,
            // l'entrepôt la réservation de stock, la liste de prix la base tarifaire.
    ...
    public function messages(): array
    {
        return [
            ...
            'expires_at.required'          => 'La date de validité est obligatoire : sans elle, le devis n\'expire jamais.',
            ...
            'warehouse_id.required'        => 'Veuillez indiquer l\'entrepôt de départ : il commande la réservation de stock.',
            'warehouse_id.exists'          => 'L\'entrepôt sélectionné est invalide.',
            'price_list.required'          => 'Veuillez indiquer la liste de prix appliquée.',
            'price_list.max'               => 'La liste de prix ne peut pas dépasser 60 caractères.',
