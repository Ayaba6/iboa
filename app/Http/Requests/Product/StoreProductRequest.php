...
class StoreProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'reference'         => 'nullable|string|max:16|unique:products,reference',
            ...
            'code_article'          => 'nullable|string|max:10|unique:products,code_article', // CDC : 10 car
    ...
    /**
     * [Vente à perte interdite] Le prix de vente ne peut pas être inférieur au prix
     * d'achat pour un article vendable. Validation croisée avec message explicite
     * (évite le rejet silencieux/cryptique côté marge).
     */
