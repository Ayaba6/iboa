...
class SalesFloorWaiver extends Model
{
    protected $fillable = [
        ...
        'cost_basis', 'cost_source', 'conversion_factor', 'margin_rate', 'line_discount',
        'global_discount_ratio', 'expected_margin', 'gap',
    ...
    protected $casts = [
        ...
        'conversion_factor' => 'decimal:6', 'margin_rate' => 'decimal:2',
        'line_discount' => 'decimal:4', 'global_discount_ratio' => 'decimal:8',
