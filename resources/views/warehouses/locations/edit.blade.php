...
<div class="max-w-3xl space-y-3">
    <div class="flex items-center justify-between">
        <h1 class="text-[16px] font-bold text-gray-900">Modifier l'emplacement</h1>
    ...
    <form method="POST" action="{{ route('stocks.warehouses.locations.update', [$warehouse, $location]) }}" class="space-y-3">
        @csrf @method('PUT')
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-medium px-6 py-1.5 rounded-[4px]">Enregistrer</button>
        </div>
    </form>
</div>
@endsection
