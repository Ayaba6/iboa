...
<div class="space-y-3">
    ...
    <form method="GET" class="bg-white rounded-[4px] border border-gray-300 p-4">
        ...
        <div class="mt-3 flex gap-2">
            ...
            <a href="{{ route('reports.liste-commandes') }}" class="border border-gray-300 text-gray-600 hover:bg-gray-50 text-sm px-2.5 py-1.5 rounded-[4px]">Réinitialiser</a>
        </div>
    </form>
    ...
    <div class="bg-white rounded-[4px] border border-gray-300 overflow-hidden">
        <table class="w-full text-sm">
            <thead class="bg-emerald-700 text-white">
                <tr>
                    <th class="px-3 py-1.5 text-left font-semibold">N° Commande</th>
            ...
            <tfoot class="bg-indigo-900 text-white font-bold">
                <tr>
                    <td class="px-3 py-1.5" colspan="4">TOTAL ({{ $totals['count'] }} commande{{ $totals['count'] > 1 ? 's' : '' }})</td>
