...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="name" value="{{ old('name', $contact->name ?? '') }}"
                           class="w-full border border-gray-300 rounded-[4px] px-3 py-2 text-sm focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="text" name="job_title" value="{{ old('job_title', $contact->job_title ?? '') }}"
                           class="w-full border border-gray-300 rounded-[4px] px-3 py-2 text-sm focus:ring-1 focus:ring-indigo-500"
    ...
    <div class="space-y-3">
        ...
        <div class="bg-white rounded-[4px] border border-gray-300 p-5">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <select name="type" class="w-full border border-gray-300 rounded-[4px] px-3 py-2 text-sm focus:ring-1 focus:ring-indigo-500" required>
                ...
                <div>
                    ...
                    <select name="status" class="w-full border border-gray-300 rounded-[4px] px-3 py-2 text-sm focus:ring-1 focus:ring-indigo-500" required>
                ...
                <div>
                    ...
                    <select name="source" class="w-full border border-gray-300 rounded-[4px] px-3 py-2 text-sm focus:ring-1 focus:ring-indigo-500" required>
        ...
        <div class="bg-white rounded-[4px] border border-gray-300 p-5">
            ...
            <select name="user_id" class="w-full border border-gray-300 rounded-[4px] px-3 py-2 text-sm focus:ring-1 focus:ring-indigo-500">
